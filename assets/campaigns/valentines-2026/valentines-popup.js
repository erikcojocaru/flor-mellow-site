(() => {
  ...
  // Setezi perioada exactă când îmi zici tu.
  // Acum e “wide range” ca să testezi ușor.
  ...
  // IMPORTANT: pune numărul tău real (fără +)
  const WHATSAPP_URL =
  ...
  // Headline block (like your 2nd mockup)
  ...
  headline.innerHTML = `
    ...
    <svg class="fm-vday-ornament" viewBox="0 0 240 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <path d="M12 12 C40 2, 70 2, 98 12 C120 22, 140 22, 162 12 C190 2, 200 2, 228 12"
            fill="none" stroke="rgba(214,170,92,0.72)" stroke-width="2" stroke-linecap="round"/>
      <circle cx="120" cy="12" r="2.5" fill="rgba(214,170,92,0.85)"/>
    </svg>
  ...
  // Show on every load (as you requested)
  setTimeout(() => document.body.appendChild(overlay), 250);
})();
